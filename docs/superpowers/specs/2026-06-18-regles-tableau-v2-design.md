...
| A4 | Libellés | Codes pièces courts : SEJ, CUIS, CH1…, BUR, BAIN, WC, CEL, DGT, EXT, GAR + nombre d'appareils entre parenthèses pour PC/PL (« Écl. CH2 CH3 DGT BAIN CEL (5) », « PC SEJ (8) », « PC CUIS (6) », « Prises GTL (2) ») ; étiquettes sur 4 lignes en 6 pt, bande Localisation du schéma en horizontal, une pièce par ligne |
